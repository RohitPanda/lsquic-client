                             ...
                             unsigned flags)
{
    ...
    if (flags & ENG_SERVER)
    {
        ...
        settings->es_initial_max_data
                                 = LSQUIC_DF_INITIAL_MAX_DATA_SERVER;
        settings->es_initial_max_stream_data
                                 = LSQUIC_DF_INITIAL_MAX_STREAM_DATA_SERVER;
    }
    else
    {
        ...
        settings->es_initial_max_data
                                 = LSQUIC_DF_INITIAL_MAX_DATA_CLIENT;
        settings->es_initial_max_stream_data
                                 = LSQUIC_DF_INITIAL_MAX_STREAM_DATA_CLIENT;
    }
    ...
    settings->es_initial_max_streams_uni
                                 = LSQUIC_DF_INITIAL_MAX_STREAMS_UNI;
    settings->es_initial_max_streams_bidi
                                 = LSQUIC_DF_INITIAL_MAX_STREAMS_BIDI;
