...
struct enc_session_funcs_iquic
{
    ...
    enc_session_t *
    (*esfi_create_client) (struct lsquic_engine_public *,
    ...
    int
    (*esfi_init_client) (enc_session_t *);

    void
    (*esfi_set_wrapper) (enc_session_t *, struct stream_wrapper *);
...
extern const struct enc_session_funcs_common lsquic_enc_session_common_id12;
...
extern const struct enc_session_funcs_iquic lsquic_enc_session_iquic_id12;

#define select_esf_common_by_ver(ver) ( \
    ver == LSQVER_ID12 ? &lsquic_enc_session_common_id12 : \
    ver == LSQVER_VERNEG ? &lsquic_enc_session_common_id12 : \
...
#define select_esf_iquic_by_ver(ver) ( \
    ver ? &lsquic_enc_session_iquic_id12 : &lsquic_enc_session_iquic_id12)
