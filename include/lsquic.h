...
/**
 * We currently support versions 35, 39, 43, 44, and IETF Draft-12
 * @see lsquic_version
 */
...
#define LSQUIC_EXPERIMENTAL_VERSIONS ((1 << LSQVER_ID12) | \
...
#define LSQUIC_IETF_VERSIONS ((1 << LSQVER_ID12) | (1 << LSQVER_VERNEG))
...
#define LSQUIC_DF_INITIAL_MAX_DATA_SERVER LSQUIC_DF_CFCW_SERVER
#define LSQUIC_DF_INITIAL_MAX_DATA_CLIENT LSQUIC_DF_CFCW_CLIENT
#define LSQUIC_DF_INITIAL_MAX_STREAM_DATA_SERVER LSQUIC_DF_SFCW_SERVER
#define LSQUIC_DF_INITIAL_MAX_STREAM_DATA_CLIENT LSQUIC_DF_SFCW_CLIENT
#define LSQUIC_DF_INITIAL_MAX_STREAMS_BIDI LSQUIC_DF_MAX_STREAMS_IN
#define LSQUIC_DF_INITIAL_MAX_STREAMS_UNI 100
...
struct lsquic_engine_settings {
     ...
     * @ref LSQUIC_DF_INITIAL_MAX_DATA_CLIENT or
     * @ref LSQUIC_DF_INITIAL_MAX_DATA_SERVER.
     */
    unsigned        es_initial_max_data;
     ...
     *
     * Depending on the engine mode, the default value is either
     * @ref LSQUIC_DF_INITIAL_MAX_STREAM_DATA_CLIENT or
     * @ref LSQUIC_DF_INITIAL_MAX_STREAM_DATA_SERVER.
     */
    unsigned        es_initial_max_stream_data;
     ...
     * This is a transport parameter.
     *
     * Default value is @ref LSQUIC_DF_INITIAL_MAX_STREAMS_BIDI.
     */
    unsigned        es_initial_max_streams_bidi;
     ...
     * This is a transport parameter.
     *
     * Default value is @ref LSQUIC_DF_INITIAL_MAX_STREAMS_UNI.
     */
    unsigned        es_initial_max_streams_uni;
